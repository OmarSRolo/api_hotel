...
<?php foreach ($content as $it): ?>


    <?php for ($index = 0; $index < count($it['roomArray']); $index++):

        $roomArray = $it['roomArray'][$index];

        $reserves_temp = $it['reservesArray'][$index];

        ?>

        <?php if (count($reserves_temp) > 0): ; ?>
        <h1><?php echo $it['owner']; ?></h1>
        ...
        <table>
            ...
            <tr style="font-weight: bold;">
                <td><?php echo($lang == 'en' ? 'Room Name' : 'Nombre de la habitaci&oacute;n'); ?></td>
                <td>
            ...
            <?php foreach ($reserves_temp as $item): ?>
                <tr>
                    <td>
                        <?php echo($lang == 'en' ? $roomArray['listing_types_name_en'] : $roomArray['listing_types_name_es']);
                        ?>
